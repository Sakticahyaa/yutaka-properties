      ...
      <section id="price" className="section-padding bg-gradient-to-br from-primary-900 to-primary-700 text-white reveal-on-scroll">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-12 mb-12">
              <div className="text-5xl md:text-6xl font-serif mb-4 text-gold-400">
                Rp 2,9 Miliar
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                ...
                <h3 className="font-semibold mb-2">Lokasi Premium</h3>
                <p className="text-sm text-gray-200">Menteng, jantung Jakarta Pusat</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                <div className="text-4xl mb-3">💰</div>
                <h3 className="font-semibold mb-2">ROI Tinggi</h3>
                <p className="text-sm text-gray-200">Permintaan sewa sangat tinggi</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                <div className="text-4xl mb-3">✨</div>
                <h3 className="font-semibold mb-2">Siap Huni</h3>
                <p className="text-sm text-gray-200">Fully furnished, tinggal pakai</p>
              </div>
            </div>
