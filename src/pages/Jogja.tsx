    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-5xl">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-transparent border-2 border-gold-400 text-gold-400 px-8 py-4 rounded-lg hover:bg-gold-400 hover:border-gold-500 hover:text-white transition-all duration-300 font-medium text-lg backdrop-blur-sm"
          >
      ...
      <section id="gallery" className="section-padding bg-gray-50 reveal-on-scroll">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-3 gap-4 max-w-5xl mx-auto transition-all duration-500">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 mb-12">
              <div className="text-center mb-8">
                ...
                <div className="text-3xl md:text-4xl font-serif mb-2 text-gold-400">
                  Estimasi Tarif Sewa
                </div>
                <div className="text-5xl md:text-6xl font-bold mb-4">
                  Rp 1,5 Juta<span className="text-2xl text-gray-300">/malam</span>
                </div>
                <p className="text-gray-200">Kapasitas besar untuk rombongan keluarga</p>
              </div>

              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border-2 border-gray-400">
                  <div className="text-center mb-4">
                    <h3 className="text-2xl font-serif mb-2">Konservatif</h3>
                    <p className="text-sm text-gray-300">Okupansi 50%</p>
                  </div>
                ...
                <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6 border-2 border-gold-400 relative">
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gold-400 text-primary-900 px-4 py-1 rounded-full text-xs font-bold">
                    REKOMENDASI
                  </div>
                  <div className="text-center mb-4">
                    <h3 className="text-2xl font-serif mb-2">Moderat</h3>
                    <p className="text-sm text-gray-300">Okupansi 67%</p>
                  </div>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-300">Per Bulan:</span>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border-2 border-gray-400">
                  <div className="text-center mb-4">
                    <h3 className="text-2xl font-serif mb-2">Optimis</h3>
                    <p className="text-sm text-gray-300">Okupansi 80%</p>
                  </div>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-300">Per Bulan:</span>
